...
Apare peste tot: în căutări, în comentarii, când dai connect. Nu o lăsa `Student la UTCB`.
...
3-4 rânduri, la persoana întâi, natural. Ce faci, ce ai construit recent, ce cauți.

Exemplu:
```
Student la Automatică și Calculatoare (UTCB). Construiesc aplicații web
full-stack. În practica de vară la DeviDevs am construit [Deadline Dog],
o aplicație de management al proiectelor de echipă: autentificare Google,
board kanban cu drag-and-drop și remindere automate pe email. Lucrez cu
...
Asta transformă practica din "am stat 3 săptămâni" în "am livrat o aplicație".

## 4. Skills

Adaugi 8-10 skills reale (nu 50). Prioritizează cele din proiect: JavaScript, TypeScript, React, Next.js, Node.js, Python, Supabase, Git, SQL. LinkedIn le folosește în matching cu joburile.
...
## Checklist
- [ ] Headline cu ce fac + stack
- [ ] About de 3-4 rânduri, concret, cu proiectul
- [ ] Practica DeviDevs la Experiență, cu link la proiect
- [ ] 8-10 skills reale
- [ ] Poză + link GitHub

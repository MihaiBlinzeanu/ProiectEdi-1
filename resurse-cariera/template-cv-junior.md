...
Exemplu real:
```
Deadline Dog - manager de task-uri pentru echipe        [live] [cod]
- Am construit un dashboard kanban cu drag-and-drop pentru task-urile
  echipei, cu autentificare Google prin Supabase Auth
- Am implementat remindere automate pe email la apropierea
  deadline-urilor, cu Resend
